...
// Create a union node
extern "C"
int gr_union_node_cmd(lua_State* L)
{
  GRLUA_DEBUG_CALL;
...
extern "C"
int gr_intersect_node_cmd(lua_State* L)
{
  GRLUA_DEBUG_CALL;
...
extern "C"
int gr_difference_node_cmd(lua_State* L)
{
  GRLUA_DEBUG_CALL;
...
// Create a hierarchical cylinder node
extern "C"
...
// Create a hierarchical cone node
extern "C"
...
int gr_render_cmd(lua_State* L)
{
  ...
  a5_render(root->node, filename, width, height,
            eye, view, up, fov,
            ambient, lights);
...
int gr_node_set_texture_cmd(lua_State* L)
{
  ...
  self->set_texture(name);

  return 0;
}

// Union two geometry node
extern "C"
int gr_node_union_cmd(lua_State* L)
{
  GRLUA_DEBUG_CALL;

  gr_node_ud* selfdata = (gr_node_ud*)luaL_checkudata(L, 1, "gr.node");
  luaL_argcheck(L, selfdata != 0, 1, "Node expected");
  UnionNode* self = dynamic_cast<UnionNode*>(selfdata->node);

  gr_node_ud* selfdata1 = (gr_node_ud*)luaL_checkudata(L, 2, "gr.node");
  SceneNode* self1 = dynamic_cast<SceneNode*>(selfdata1->node);
  luaL_argcheck(L, self1 != 0, 2, "Node expected");

  gr_node_ud* selfdata2 = (gr_node_ud*)luaL_checkudata(L, 3, "gr.node");
  SceneNode* self2 = dynamic_cast<SceneNode*>(selfdata2->node);
  luaL_argcheck(L, self2 != 0, 3, "Node expected");
  
  self->add_child( self1 );
  self->add_child( self2 );
  
  return 0;
}

// Intersect two geometry node
extern "C"
int gr_node_intersect_cmd(lua_State* L)
{
  GRLUA_DEBUG_CALL;

  gr_node_ud* selfdata = (gr_node_ud*)luaL_checkudata(L, 1, "gr.node");
  luaL_argcheck(L, selfdata != 0, 1, "Node expected");
  IntersectNode* self = dynamic_cast<IntersectNode*>(selfdata->node);

  gr_node_ud* selfdata1 = (gr_node_ud*)luaL_checkudata(L, 2, "gr.node");
  GeometryNode* self1 = dynamic_cast<GeometryNode*>(selfdata1->node);
  luaL_argcheck(L, self1 != 0, 2, "Geometry node expected");

  gr_node_ud* selfdata2 = (gr_node_ud*)luaL_checkudata(L, 3, "gr.node");
  GeometryNode* self2 = dynamic_cast<GeometryNode*>(selfdata2->node);
  luaL_argcheck(L, self2 != 0, 3, "Geometry node expected");
...
// Difference two geometry node
extern "C"
int gr_node_difference_cmd(lua_State* L)
{
  GRLUA_DEBUG_CALL;

  gr_node_ud* selfdata = (gr_node_ud*)luaL_checkudata(L, 1, "gr.node");
  luaL_argcheck(L, selfdata != 0, 1, "Node expected");
  DifferenceNode* self = dynamic_cast<DifferenceNode*>(selfdata->node);
...
static const luaL_reg grlib_functions[] = {
  {"node", gr_node_cmd},
  {"union_node", gr_union_node_cmd},
  {"intersect_node", gr_intersect_node_cmd},
  {"difference_node", gr_difference_node_cmd},
...
static const luaL_reg grlib_node_methods[] = {
  ...
  {"render", gr_render_cmd},
  {"union", gr_node_union_cmd},
  {"intersect", gr_node_intersect_cmd},
  {"difference", gr_node_difference_cmd},
  {0, 0}
};
